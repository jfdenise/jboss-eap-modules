...
Scenario: Test custom galleon config, default dir
    Given s2i build git://github.com/jfdenise/jboss-eap-modules from tests/examples/test-custom-galleon using CLOUD_3928
      | variable                                                  | value                                                    |
 ...
 Scenario: Test custom galleon config failing, unknown layer
    Given failing s2i build git://github.com/jfdenise/jboss-eap-modules from tests/examples/test-custom-galleon using CLOUD_3928
      | variable                                                  | value                                                    |
      | GALLEON_PROVISION_LAYERS            | jaxrs-server,foo,bar    |
      | GALLEON_DIR                                        | my/custom/galleon |
